-- --------------------------------------------------
-- 1. Insert Data into `dams` Table
-- --------------------------------------------------
-- This section inserts detailed information about each dam,
-- including its unique identifier, name, full storage volume,
...
-- --------------------------------------------------
-- 2. Insert Data into `dam_groups` Table
-- --------------------------------------------------
-- This section categorizes dams into different groups for
...
-- --------------------------------------------------
-- 3. Insert Data into `dam_group_members` Table
-- --------------------------------------------------
-- This section maps each dam to its respective group(s),
-- establishing many-to-many relationships between dams and groups.

-- Sydney Dams Group Members
...
-- Greatest Released Dams Group Members
INSERT INTO dam_group_members (group_name, dam_id) VALUES
...
-- --------------------------------------------------
-- 4. Insert Data into `latest_data` Table
-- --------------------------------------------------
-- This section records the most recent data for each dam,
-- including storage volume, percentage full, inflow, and release rates.
...
INSERT INTO latest_data (dam_id, dam_name, date, storage_volume, percentage_full, storage_inflow, storage_release) VALUES
    ...
    ('416030', 'Pindari Dam', '2024-11-25', 311500.000, 99.50, 900.000, 600.300),
...
-- --------------------------------------------------
-- 5. Insert Data into `dam_resources` Table
-- --------------------------------------------------
-- This section records historical monthly data for each dam,
-- capturing storage volume, percentage full, inflow, and release rates.

-- Toonumbar Dam (203042) Historical Data
...
-- Glenbawn Dam (210097) Historical Data
INSERT INTO dam_resources (dam_id, date, storage_volume, percentage_full, storage_inflow, storage_release) VALUES
...
-- Lostock Dam (210102) Historical Data
INSERT INTO dam_resources (dam_id, date, storage_volume, percentage_full, storage_inflow, storage_release) VALUES
...
-- Glennies Creek Dam (210117) Historical Data
INSERT INTO dam_resources (dam_id, date, storage_volume, percentage_full, storage_inflow, storage_release) VALUES
    ('210117', '2023-10-01', 280000.000, 95.00, 1800.500, 1300.300),
    ('210117', '2023-11-01', 282303.000, 97.00, 1850.500, 1350.300),
    ('210117', '2023-12-01', 285000.000, 99.00, 1900.500, 1400.300);

-- Warragamba Dam (212243) Historical Data
INSERT INTO dam_resources (dam_id, date, storage_volume, percentage_full, storage_inflow, storage_release) VALUES
    ('212243', '2023-10-01', 2064000.000, 98.00, 2500.700, 1800.600),
    ('212243', '2023-11-01', 2064500.000, 99.00, 2520.700, 1850.600),
    ('212243', '2023-12-01', 2064680.000, 100.00, 2550.700, 1900.600);

-- Blowering Dam (410102) Historical Data
INSERT INTO dam_resources (dam_id, date, storage_volume, percentage_full, storage_inflow, storage_release) VALUES
...
-- Burrinjuck Dam (410131) Historical Data
INSERT INTO dam_resources (dam_id, date, storage_volume, percentage_full, storage_inflow, storage_release) VALUES
...
-- Lake Wyangala (412010) Historical Data
INSERT INTO dam_resources (dam_id, date, storage_volume, percentage_full, storage_inflow, storage_release) VALUES
...
-- Lake Cargelligo (412107) Historical Data
INSERT INTO dam_resources (dam_id, date, storage_volume, percentage_full, storage_inflow, storage_release) VALUES
    ('412107', '2023-10-01', 30000.000, 99.80, 620.100, 360.900),
    ('412107', '2023-11-01', 30500.000, 99.85, 630.100, 365.900),
    ('412107', '2023-12-01', 31000.000, 99.90, 640.100, 370.900);

-- --------------------------------------------------
-- 6. Insert Data into `specific_dam_analysis` Table
-- --------------------------------------------------
-- This section stores analytical data for each dam over different
-- time periods (12 months, 5 years, and 20 years), including
-- average storage volume, percentage full, inflow, and release rates.
...
-- --------------------------------------------------
-- 7. Insert Data into `overall_dam_analysis` Table
-- --------------------------------------------------
-- This section records overall analytical data for all dams combined,
-- calculating average metrics over different time periods.
...
INSERT INTO overall_dam_analysis (
    ...
    ('2024-11-01', 500000.000, 480000.000, 460000.000, 95.00, 93.00, 90.00, 1500.000, 1400.000, 1300.000, 1000.000, 950.000, 900.000);
